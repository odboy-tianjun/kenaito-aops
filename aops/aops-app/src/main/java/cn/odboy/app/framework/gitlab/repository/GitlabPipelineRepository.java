...
import cn.odboy.app.framework.gitlab.callback.GitlabPipelineJobExecuteCallback;
...
import cn.odboy.app.framework.gitlab.model.GitlabPipelineJobInfoResponse;
...
public class GitlabPipelineRepository {
    ...
    private void showJobInfo(Pipeline currentPipeline, GitlabPipelineJobExecuteCallback callback) {
        ...
        for (Job job : jobs) {
            ...
            callback.execute(GitlabPipelineJobInfoResponse.builder()
                    .id(job.getId())
