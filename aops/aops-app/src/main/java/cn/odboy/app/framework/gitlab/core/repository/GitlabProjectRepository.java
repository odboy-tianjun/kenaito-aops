...
import cn.odboy.app.framework.gitlab.core.context.GitlabCiFileAdmin;
import cn.odboy.app.framework.gitlab.core.context.GitlabIgnoreFileAdmin;
...
public class GitlabProjectRepository {
    ...
    private GitlabProjectCreateVo transformCreateResp(GitlabProjectCreateArgs args, Project newProject, String newProjectName) {
        GitlabProjectCreateVo createResp = new GitlabProjectCreateVo();
