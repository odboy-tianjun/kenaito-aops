...
public class KruiseAppsV1alpha1CompletionPolicy {
    ...
    /**
     * ttlSecondsAfterFinished limits the lifetime of a JobDO that has finished execution (either Complete or Failed). If this field is set, ttlSecondsAfterFinished after the JobDO finishes, it is eligible to be automatically deleted. When the JobDO is being deleted, its lifecycle guarantees (e.g. finalizers) will be honored. If this field is unset, the JobDO won&#39;t be automatically deleted. If this field is set to zero, the JobDO becomes eligible to be deleted immediately after it finishes. This field is alpha-level and is only honored by servers that enable the TTLAfterFinished feature. Only works for Always type
     *
     * @return ttlSecondsAfterFinished
     **/
    @ApiModelProperty(value = "ttlSecondsAfterFinished limits the lifetime of a JobDO that has finished execution (either Complete or Failed). If this field is set, ttlSecondsAfterFinished after the JobDO finishes, it is eligible to be automatically deleted. When the JobDO is being deleted, its lifecycle guarantees (e.g. finalizers) will be honored. If this field is unset, the JobDO won't be automatically deleted. If this field is set to zero, the JobDO becomes eligible to be deleted immediately after it finishes. This field is alpha-level and is only honored by servers that enable the TTLAfterFinished feature. Only works for Always type")
